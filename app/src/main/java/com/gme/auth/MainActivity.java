...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirestoreRecyclerOptions<MODEL_class> options=new FirestoreRecyclerOptions.Builder<MODEL_class>()
         ...
         adapter= new FirestoreRecyclerAdapter<MODEL_class, UsersViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull UsersViewHolder holder, int position, @NonNull MODEL_class model) {
