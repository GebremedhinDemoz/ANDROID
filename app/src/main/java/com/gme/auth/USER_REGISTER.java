...
public class USER_REGISTER extends AppCompatActivity {
    ...
    EditText mFullName,mEmail,mPassword,mPhone,mConfirmPass,mUserName;
    Button mRegisterBtn;
    TextView mLoginBtn;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String confirmpass=mConfirmPass.getText().toString();
                ...
                if(comp!=0){
                    mConfirmPass.setError("Password didn't match!");
                }
                ...
                // USER_REGISTER the user in firebase
